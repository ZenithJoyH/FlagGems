...
"""Packed GDN decode with FP32 beta and recurrent state.

The wrapper preserves a tensor-only packed-QKV and in-place state ABI
without importing an inference framework.
"""

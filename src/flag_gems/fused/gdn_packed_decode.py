...
"""Packed GDN decode; beta and recurrent state stay FP32.

The wrapper preserves the packed-QKV and in-place state ABI used by day-0
serving integrations without importing an inference framework.
"""
...
def gdn_packed_decode(
    ...
    if A_log.numel() != HV or dt_bias.numel() != HV:
        raise ValueError(
            ...
            f"(got A_log.numel()={A_log.numel()}, "
            f"dt_bias.numel()={dt_bias.numel()})."
        )
